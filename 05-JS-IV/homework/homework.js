...
function eliminarPropiedad (objeto, unaPropiedad) {
  ...
  // return objeto
  // Mejor practica no eliminar la propiedad, poner en undefined
  if (objeto[unaPropiedad] === undefined) {
    return objeto;
  } else {
...
function sumarLikesDeUsuario (usuario) {
  ...
  for(var i = 0; i < usuario.posts.length; i++) {
    likesNum += usuario.posts[i].likes;
  }
  return likesNum;
}
...
function agregarMetodoCalculoDescuento (producto) {
  ...
  producto["calcularPrecioDescuento"] = function() {
    // return producto.precio - producto.porcentajeDeDescuento*producto.precio; //Tambien funciona
